...
static int enumr1_probe(void *probe_data)
{
	CU_ASSERT(probe_data == ENUMR1_PROBE_DATA);
	enumr1_probed = 1;
	return 0;
}
...
static int enumr2_probe(void *probe_data UNUSED)
{
	enumr2_probed = 1;
	return 0;
}

static int enumr3_probe(void *probe_data UNUSED)
{
	enumr3_probed = 1;
	return 0;
}

static int enumr4_probe(void *probe_data UNUSED)
{
	enumr4_probed = 1;
	return 0;
}
